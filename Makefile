...
lint-py:  ## run python linter with ruff
	python -m ruff check finance_portfolio
	python -m ruff format --check finance_portfolio
...
fix-py:  ## fix python formatting with ruff
	python -m ruff check --fix finance_portfolio
	python -m ruff format finance_portfolio
...
test-py:  ## run python tests
	python -m pytest -v finance_portfolio/tests

# alias
tests-py: test-py

coverage-py:  ## run python tests and collect test coverage
	python -m pytest -v finance_portfolio/tests --cov=finance_portfolio --cov-report term-missing --cov-report xml
